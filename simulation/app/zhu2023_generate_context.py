#!/usr/bin/env python3
"""Generate Zhu2023 offline context for the simulator."""
...
from zhu2023_context import DEFAULT_VALIDITY_TS, generate_offline_context, save_context


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate Zhu2023 offline context")
