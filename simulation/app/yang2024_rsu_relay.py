#!/usr/bin/env python3
"""Relay RSU (LEO1) server for Yang2024 handover experiments."""
...
from yang2024_codec import decode_payload, encode_switch_response, ensure_type

logger = logging.getLogger("yang2024_rsu1")


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Yang2024 relay RSU server")
