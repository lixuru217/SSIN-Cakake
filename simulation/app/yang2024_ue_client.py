#!/usr/bin/env python3
"""UE client driving the Yang2024 RSU handover handshake."""
...
import yang2024
from yang2024_codec import decode_payload, encode_switch_request, ensure_type
from yang2024_context import get_rsu_ids, get_vehicle_state, load_context


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Yang2024 UE handover client")
...
def _broadcast_payload_len(broadcast: yang2024.SignedBroadcast) -> int:
