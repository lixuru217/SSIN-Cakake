#!/usr/bin/env python3
"""Application server verifying Zhu2023 aggregate signatures."""
...
logger = logging.getLogger("zhu2023_app")


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Zhu2023 application server process")
